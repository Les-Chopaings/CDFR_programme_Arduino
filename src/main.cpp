...
int limitWithRotation1(int angle) {
  ...
  angle = ((slider1->get() <= 60 && slider2->get() == 180) || fullRotation==false) ? angle : rotation1->get();
  return angle;
}
int limitWithRotation2(int angle) {
  bool fullRotation = abs(angle - rotation2->get()) > 120;
  angle = ((slider1->get() == 0 && slider2->get() >= 40 && slider2->get() <= 60 && slider3->get() == 180) || fullRotation==false) ? angle : rotation2->get();
  return angle;
}
int limitWithRotation3(int angle) {
  bool fullRotation = abs(angle - rotation3->get()) > 120;
  angle = ((slider2->get() == 0 && slider3->get() >= 40 && slider3->get() <= 60 && slider4->get() == 180) || fullRotation==false) ? angle : rotation3->get();
  return angle;
}
